...
- Name: success-error-handling.spec.ts >> FR-006: Upload Success Confirmation >> AC-013: System displays success message after upload
- Location: tests\success-error-handling.spec.ts:43:7
...
> 49  |     const fileChooserPromise = page.waitForEvent('filechooser');
  ...
  103 | 
  104 |     // Upload file
  105 |     const fileChooserPromise = page.waitForEvent('filechooser');
