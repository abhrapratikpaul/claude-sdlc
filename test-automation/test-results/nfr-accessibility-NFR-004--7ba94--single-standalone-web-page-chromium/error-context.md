...
- Name: nfr-accessibility.spec.ts >> NFR-004: UI Simplicity >> AC-031: Interface is a single standalone web page
- Location: tests\nfr-accessibility.spec.ts:153:7
...
Call log:
  ...
  - waiting for locator('#messageArea')
    14 × locator resolved to <div role="alert" id="messageArea" class="message-area" aria-live="assertive"></div>
